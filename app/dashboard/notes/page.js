...
//         {notes.map((note) => (
//           <Card key={note._id} className={`${note.color}`}>
//             <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
//               {editingId === note._id ? (
//                 <Input
//                   value={note.title}
//                   onChange={(e) =>
//                     updateNote(note._id, { title: e.target.value })
//                   }
...
//                 </Button>
//               ) : (
//                 <Button variant="ghost" onClick={() => setEditingId(note._id)}>
              ...
              {editingId === note._id ? (
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    setTempNote({ title: note.title, content: note.content });
                  }}
                >
                  <Edit2 className="mr-2 h-4 w-4" /> Edit
                </Button>
